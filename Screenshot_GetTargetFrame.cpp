...
void RenderFrame(void) {
	...
	d3ddev->Clear(0, NULL, D3DCLEAR_TARGET, D3DCOLOR_XRGB(250, 40, 100), 0.1f, 0);
	...
	d3ddev->GetRenderTarget(0, &backbf);
	D3DXSaveSurfaceToFile(L"G:\\1\\1.bmp", D3DXIFF_BMP, backbf, 0, 0);
