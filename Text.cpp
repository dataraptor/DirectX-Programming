...
void RenderFrame(void) {
	...
	//d3ddev->CreateOffscreenPlainSurface(SCREEN_WIDTH, SCREEN_HEIGHT, D3DFMT_X8R8G8B8, D3DPOOL_SYSTEMMEM, &copy, 0);
	

	// clear the window to deep blue
	d3ddev->Clear(0, NULL, D3DCLEAR_TARGET, D3DCOLOR_XRGB(i*50, 40, 100), 0.1f, 0);  i++;
	...
	//D3DXSaveSurfaceToFile(L"G:\\1\\1.bmp", D3DXIFF_BMP, copy, 0, 0);
